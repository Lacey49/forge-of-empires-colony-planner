  ...
  function makeInflatable39State() {
    ...
    for (let dr = 0; dr < hall.h; dr++) {
      for (let dc = 0; dc < hall.w; dc++)
        grid[INFLATABLE_39_HUB[0] + dr][INFLATABLE_39_HUB[1] + dc] = "hub";
    }
    ...
    for (const [r, c] of INFLATABLE_39_HOMES)
      addBuilding("inflatableHome", r, c);
    for (const [r, c] of INFLATABLE_39_FLOATING)
